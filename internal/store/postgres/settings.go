...
func (c *Connector) PublicSettings(ctx context.Context) (map[string]any, error) {
	...
	out := map[string]any{
		...
		"codex_shell_target":            stringSetting(values, "codex_shell_target", "auto"),
		"codex_shell_target_options":    []string{"auto", "powershell", "posix"},
...
func (c *Connector) UpdateRuntimeSettings(ctx context.Context, patch map[string]any) (map[string]any, error) {
	...
	specs := []fieldSpec{
		...
		{key: "codex_shell_target", kind: "string", enums: []string{"auto", "powershell", "posix"}},
